...
>
  <span className="font-extrabold text-white">EmpAI</span>는 구직자들에게 스마트한 취업 준비를 돕기 위해 
  <span className="font-extrabold text-white"> 지도 기반 기업 탐색 자기소개서 관리 & 피드백</span>, 
  AI 면접 예상 질문 생성, <span className="font-extrabold text-white">AI 모의 면접 & 피드백</span> 등 
